...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("HomeWork_NetCore3._0.Models.Course", b =>
                {
            ...
            modelBuilder.Entity("HomeWork_NetCore3._0.Models.CourseInstructor", b =>
                {
                    b.Property<int>("CourseId")
                        .HasColumnName("CourseID")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("HomeWork_NetCore3._0.Models.Department", b =>
                {
                    b.Property<int>("DepartmentId")
                        .ValueGeneratedOnAdd()
                        .HasColumnName("DepartmentID")
            ...
            modelBuilder.Entity("HomeWork_NetCore3._0.Models.Enrollment", b =>
                {
            ...
            modelBuilder.Entity("HomeWork_NetCore3._0.Models.OfficeAssignment", b =>
                {
                    b.Property<int>("InstructorId")
                        .HasColumnName("InstructorID")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("HomeWork_NetCore3._0.Models.Person", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnName("ID")
            ...
            modelBuilder.Entity("HomeWork_NetCore3._0.Models.Course", b =>
                {
                    b.HasOne("HomeWork_NetCore3._0.Models.Department", "Department")
                        .WithMany("Course")
            ...
            modelBuilder.Entity("HomeWork_NetCore3._0.Models.CourseInstructor", b =>
                {
                    b.HasOne("HomeWork_NetCore3._0.Models.Course", "Course")
                    ...
                    b.HasOne("HomeWork_NetCore3._0.Models.Person", "Instructor")
                        .WithMany("CourseInstructor")
            ...
            modelBuilder.Entity("HomeWork_NetCore3._0.Models.Enrollment", b =>
                {
                    ...
                    b.HasOne("HomeWork_NetCore3._0.Models.Person", "Student")
                        .WithMany("Enrollment")
            ...
            modelBuilder.Entity("HomeWork_NetCore3._0.Models.OfficeAssignment", b =>
                {
                    b.HasOne("HomeWork_NetCore3._0.Models.Person", "Instructor")
                        ...
                        .HasForeignKey("HomeWork_NetCore3._0.Models.OfficeAssignment", "InstructorId")
